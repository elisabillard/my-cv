export const cvData = {
  ...
  thesis: "Deep learning for cancer diagnosis using spectral pathology (Infra-Red & Raman). Developing CycleGAN-based and U-Net virtual staining models to generate reliable histopathological (H&E) images. Supervised by Prof. Pietro Liò and Prof. Charlotte Bunne (EPFL)",
  ...
  education: [
    ...
    date: "2023 - 2025", 
    gpa: "5.5/6",
    specialization: "Biological Data Science",
    computational: ["Machine Learning (5/6)", "Applied Data Analysis (5.75/6)", "Digital Epidemiology", "Bioimage Informatics", "Biostatistics"],
  ...
  { 
    ...
    date: "2019 - 2022", 
    gpa: "5.1/6",
    computational: ["OOP", "Physics", "Algebra", "Statistics & Probability", "Machine Learning"],
    biology: ["Synthetic Biology", "Immuno-engineering", "Oncology", "Genetics & Genomics"]
  },
  { 
    school: "LFZ", 
...
papers: [
    ...
    { 
      ...
      year: "2025", 
      note: "12,000 CHF to finance my research project on deep learning for Raman spectral pathology in the University of Cambridge, under supervision of Prof. Pietro Liò - Cambridge University and Prof. Charlotte Bunne - EPFL", 
    }
  ],
  projects: [
  ...
  skills: {
    programming: ["Python (PyTorch, Scikit-learn)", "R", "C++", "Julia", "Java", "Git", "Docker"],
